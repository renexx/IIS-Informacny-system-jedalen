...
@else
      <div class="novaP">
          ...
          <div class="col-auto order-md-1">
            ...
            <h4 class="mb-3">Upraviť jedlo </h4>

            <form action="{{route('jedlo.update',["$jedlo->id_jedlo"])}}" method="post" class="needs-validation" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-md-10 mb-3">
                  <label for="popis">Názov</label>
                  <input type="text" name="popis" class="form-control"  placeholder="" value="{{old('popis') ?: $jedlo->popis}}" required="">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" pattern="[0-9]+" name="hmotnost" class="form-control" placeholder="" value="{{old('hmostnost') ?: $jedlo->hmotnost}}" required="">
                        <div class="invalid-feedback">
                            Vyplňte hmotnosť.
                        </div>
                    </div>
              ...
              <div class="row">
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" name="cena" pattern="[0-9]+" class="form-control" placeholder="" value="{{old('cena') ?: $jedlo->cena}}" required="">
                  <div class="invalid-feedback">
                    Vyplňte cenu.
                  </div>
                </div>
              ...
              <!-- <div class="row">
                <div class="col-md-2 mb-3">
                  <label for="id_stala_ponuka">Stála ponuka</label>
                  <input type="text" name="id_stala_ponuka" class="form-control" placeholder="" value="{{old('id_stala_ponuka') ?: $jedlo->id_stala_ponuka}}" required="">
                  <div class="invalid-feedback">
                    Vyplňte stálu ponuku.
                  </div>
                </div>
              </div> -->
